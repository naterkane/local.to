...
class Admin extends App_controller
{
  ...
  function clearsessions()
  {
	...
	function stats()
	{
		...
		foreach($this->User->redis->keys('*') as $key)
		{
			//$all[$key] = $this->User->tt->get($key);
			$all[$key] = $this->User->redis->get($key);
		...
		ksort($all);
		echo "<a href=\"/admin/clearsessions\">Clear Sessions</a> <a href=\"/tests/testme\">Go to Tests</a> <a href=\"/admin/showdata\">Reloads</a><br>";		
