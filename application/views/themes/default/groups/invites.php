...
<?php $this->load->view("groups/subnav/group_nav"); ?>	
	<form class="grid_9 alpha" action="/groups/invites/<?php echo $group['name']; ?>" method="post">
		<fieldset>
			...
			<p class="text">To ensure team privacy, only those invited via email by the team admin will be able to access the team page and view the updates. Please enter the emails of users you would like to grant access to this team network</p>
