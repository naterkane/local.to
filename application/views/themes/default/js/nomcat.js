var nc = {
	...
	*/
    ...
    showGowallaForm: function() {
		//if ($('#gowalla_form_hide_link')) {
			$('#gowalla_form .submit:not(:has(#gowalla_form_hide_link))').append(' <a id="gowalla_form_hide_link" href="javascript:nc.hideGowallaForm()">Cancel</a>');//.parent().show('fast');
		//} else {
			$('#gowalla_form').show('fast');
		//}	
	},
	hideGowallaForm: function() {
		$('#gowalla_form').hide('fast');
	},
  	/**
  	 * initialization 
  	 */
