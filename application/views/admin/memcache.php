...
define('ADMIN_USERNAME','nom'); 	// Admin Username
define('ADMIN_PASSWORD','Flushwick99');  	// Admin Password
define('DATE_FORMAT','Y/m/d H:i:s');
define('GRAPH_SIZE',200);
define('MAX_ITEM_DUMP',50);

$MEMCACHE_SERVERS[] = '67.23.9.219:1978'; // add more as an array
//$MEMCACHE_SERVERS[] = 'wearenom.com:11211'; // add more as an array
